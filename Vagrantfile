...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "wallnerryan-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cyp"
  #   chef.validation_client_name = "cyp-validator"
  #   chef.validation_key_path = ".chef/cyp-validator.pem"
  # end
end
